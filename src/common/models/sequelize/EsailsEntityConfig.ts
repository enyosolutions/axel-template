...
jsonParseHook,
bulkJsonParseHook} from '../../../common/services/SequelizeHooks';
/*
  ...
  entity: {
    ...
    options: {
      ...
      hooks: {
        ...
        afterSave: jsonParseHook(['options', 'layout', 'actions'], {}),
        beforeValidate: jsonStringifyHook(['options', 'layout', 'actions'], {}),
        afterFind: bulkJsonParseHook(['options', 'layout', 'actions'], {}),
        beforeBulkCreate: bulkJsonStringifyHook(['options', 'layout', 'actions'], {}),
        beforeBulkUpdate: bulkJsonStringifyHook(['options', 'layout', 'actions'], {}),
      },
      indexes: [
        // {
        //  unique: false,
